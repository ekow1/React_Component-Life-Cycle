      ...
      <MDBRow>
        <MDBCol size='3'>
          <MDBTabs className='flex-column text-center fw-bold fs-4'>
            <MDBTabsItem>
              <MDBTabsLink onClick={() => handleVerticalClick('tab1')} active={verticalActive === 'tab1'} className='  fs-5'>
                Fetch F-Component
              </MDBTabsLink>
            </MDBTabsItem>
            <MDBTabsItem>
              <MDBTabsLink onClick={() => handleVerticalClick('tab2')} active={verticalActive === 'tab2'} className='  fs-5'>
              Fetch C-Component
              </MDBTabsLink>
            </MDBTabsItem>
            <MDBTabsItem>
              <MDBTabsLink onClick={() => handleVerticalClick('tab3')} active={verticalActive === 'tab3'} className='  fs-5'
>
               Axios F-Component
              </MDBTabsLink>
            </MDBTabsItem>
            <MDBTabsItem>
              <MDBTabsLink onClick={() => handleVerticalClick('tab4')} active={verticalActive === 'tab4'} className='  fs-5'
>
                Axios C-Component
              </MDBTabsLink>
            </MDBTabsItem>
